...
```{r}
data_for_plot_slope$half_life_med_pop <- 24*log10(2)/(-(data_for_plot_slope$beta_hat))

hl_before <- data_for_plot_slope$half_life_med_pop[data_for_plot_slope$Rand_date == min(data_for_plot_slope$Rand_date)]


hl_after <- data_for_plot_slope$half_life_med_pop[data_for_plot_slope$Rand_date == max(data_for_plot_slope$Rand_date)]

writeLines(sprintf('Estimated population clearance half-life at the beginning of the trial: %s hours \nEstimated population clearance half-life in late 2023: %s hours',
               round(hl_before,1),
               round(hl_after,1)))
