...
for(i in 1:nrow(ind_tab)){
  ...
  ind_tab$hl_before_low[i] <- slope_to_hl(slope_before[1])
  ind_tab$hl_before_med[i] <- slope_to_hl(slope_before[2])
  ind_tab$hl_before_up[i] <- slope_to_hl(slope_before[3])
  ind_tab$hl_after_low[i] <- slope_to_hl(slope_after[1])
  ind_tab$hl_after_med[i] <- slope_to_hl(slope_after[2])
  ind_tab$hl_after_up[i] <- slope_to_hl(slope_after[3])
